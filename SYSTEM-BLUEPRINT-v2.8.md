...
**Version**: 2.8 | **Owner**: KB-Orchestrator-Core (Claude Code)
...
|---|---|---|---|
| `probe` | — | `{available: bool, protocol: int, capabilities: [...]}` | Run at orchestrator startup. Failure → adapter marked unavailable; agents bound to it cannot be assigned. |
